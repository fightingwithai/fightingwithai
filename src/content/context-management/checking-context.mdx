...
In this example, after a mistake that generated noise, the context was 57% full. The breakdown revealed accumulated message tokens from failed attempts—a signal that [[clear|clearing]] would produce better results than continuing.
...
This is particularly useful before [[clear|clearing]] or [[compact|compacting]]—you can verify whether context is salvageable or too polluted to work with.
